...
* **Key resources**:
  * [Hummingbot](https://github.com/hummingbot/hummingbot) ⭐ 20,141 | 🐛 172 | 🌐 Python | 📅 2026-09-22 - Open-source framework for running market-making and arbitrage bots on centralized and decentralized exchanges.
...
* **Key resources**:
  * [pysystemtrade](https://github.com/robcarver17/pysystemtrade) ⭐ 3,522 | 🐛 35 | 🌐 Python | 📅 2026-09-21 - Robert Carver's open-source systematic futures trading framework implementing his book's methodology.
...
* **Key resources**:
  * [machine-learning-for-trading](https://github.com/stefan-jansen/machine-learning-for-trading) ⭐ 20,971 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-09-21 - Stefan Jansen's companion code to his book: 150+ notebooks covering the full ML4T workflow from data to deployment.
...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 108,037 | 🐛 170 | 🌐 Python | 📅 2026-09-18 - Multi-agent LLM trading framework simulating trading firm dynamics with specialized analyst and trader roles; built with LangGraph, supports GPT, Gemini, Claude, and Grok.
* [Vibe-Trading](https://github.com/HKUDS/Vibe-Trading) ⭐ 33,822 | 🐛 28 | 🌐 Python | 📅 2026-09-22 - Natural-language multi-agent finance research framework with 29 swarm presets (investment committee, quant desk, risk committee); 7 cross-market backtest engines (A-shares/US/Crypto/Futures/Forex/Options) plus a shared-capital CompositeEngine; 5-source auto-fallback data layer (tushare/okx/yfinance/akshare/ccxt); 17-tool MCP server for Claude Desktop; CLI + FastAPI + React frontend.
* [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) ⭐ 21,272 | 🐛 53 | 🌐 Jupyter Notebook | 📅 2026-09-14 - Open-source financial LLM framework with data-centric design and LoRA fine-tuning; supports sentiment analysis, robo-advising, and algorithmic trading.
* [FinRL](https://github.com/AI4Finance-Foundation/FinRL) ⭐ 16,372 | 🐛 312 | 🌐 Jupyter Notebook | 📅 2026-09-22 - Financial reinforcement learning framework supporting A2C, DDPG, PPO, TD3, SAC agents; FinRL-X adds modular infrastructure for the LLM/agentic AI era.
* [FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) ⭐ 8,049 | 🐛 76 | 🌐 Jupyter Notebook | 📅 2026-09-11 - Open-source AI agent platform for financial analysis using LLMs with Financial Chain-of-Thought reasoning and smart scheduler for multi-source LLM integration.
* [oracle3](https://github.com/YichengYang-Ethan/oracle3) ⭐ 256 | 🐛 18 | 🌐 Python | 📅 2026-05-08 - Autonomous prediction-market trading agent for Kalshi, Polymarket, and Solana DFlow using Wang Transform pricing, Greeks, Kelly sizing, and constraint-based arbitrage strategies; Apache-2.0 with methodology documented in a companion SSRN working paper.
...
* [TimesFM](https://github.com/google-research/timesfm) ⭐ 33,446 | 🐛 256 | 🌐 Python | 📅 2026-09-15 - Google Research's decoder-only foundation model (200M params) pre-trained on 100B real-world time points.
* [Chronos](https://github.com/amazon-science/chronos-forecasting) ⭐ 5,894 | 🐛 38 | 🌐 Python | 📅 2026-09-17 - Amazon's pretrained time series models; Chronos-2 (120M params) handles univariate, multivariate, and covariate-informed zero-shot forecasting.
* [TimeGPT](https://github.com/Nixtla/nixtla) ⭐ 4,011 | 🐛 63 | 🌐 Jupyter Notebook | 📅 2026-09-21 - Production-ready foundation model trained on 100B+ data points with open-source Python/R SDK; offers zero-shot forecasting and anomaly detection via API.
* [PatchTST](https://github.com/yuqinie98/PatchTST) ⭐ 2,710 | 🐛 61 | 🌐 Python | 📅 2024-08-12 - Segments time series into subseries-level patches as transformer tokens, achieving quadratic reduction in attention cost while retaining local semantics.
...
* [Moirai](https://github.com/SalesforceAIResearch/uni2ts) ⭐ 1,596 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2026-06-02 - Salesforce's masked encoder-based universal forecasting transformer, pre-trained on LOTSA (27B observations, 9 domains); handles any frequency and any number of variates.
...
* [RD-Agent](https://github.com/microsoft/RD-Agent) ⭐ 14,711 | 🐛 230 | 🌐 Python | 📅 2026-09-15 - Microsoft's LLM-based autonomous R\&D agent; its quantitative-finance mode (RD-Agent(Q)) iteratively proposes, codes, and backtests factors and models on top of Qlib.
* [AlphaGen](https://github.com/RL-MLDM/alphagen) ⭐ 1,242 | 🐛 23 | 🌐 Python | 📅 2026-06-04 - Reinforcement learning framework for generating formulaic alpha factors, optimizing the performance of the factor set as a whole rather than individual factors.
...
* [Flashbots mev-boost](https://github.com/flashbots/mev-boost) ⭐ 1,444 | 🐛 88 | 🌐 Go | 📅 2026-06-30 - Reference implementation of proposer-builder separation (PBS) for Ethereum; core infrastructure for the MEV supply chain.
* [Flashbots rbuilder](https://github.com/flashbots/rbuilder) ⭐ 569 | 🐛 107 | 🌐 Rust | 📅 2026-09-09 - Open-source, high-performance Ethereum MEV-Boost block builder written in Rust; supports multiple building algorithms and backtesting.
* [DefiLlama](https://defillama.com/) - Open-source DeFi analytics dashboard tracking TVL, yields, fees, and volumes across thousands of protocols; provides free API via [defillama-sdk](https://github.com/DefiLlama/defillama-sdk) ⭐ 77 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-19.
...
| **Tool**                                                                                                                 | **Strength**                                                                                                             | **Notes**                                                                                                                                                      |
| ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[Qlib](https://github.com/microsoft/qlib) ⭐ 48,748 \| 🐛 480 \| 🌐 Python \| 📅 2026-09-22**                           | AI-oriented quant research platform: factor library, model zoo, workflow automation                                      | Microsoft; the reference open-source platform for ML-driven quant research                                                                                     |
| **[OpenBB](https://github.com/OpenBB-finance/OpenBB) ⭐ 73,363 \| 🐛 115 \| 🌐 Python \| 📅 2026-09-22**                  | Open-source investment research terminal aggregating equity, macro, and crypto data                                      | Free CLI + SDK; large active community                                                                                                                         |
| **[LEAN](https://github.com/QuantConnect/Lean) ⭐ 21,719 \| 🐛 257 \| 🌐 C# \| 📅 2026-09-21**                            | Institution-grade backtesting and live-trading engine (equities, futures, options, crypto)                               | Open-source engine behind QuantConnect                                                                                                                         |
| **[NautilusTrader](https://github.com/nautechsystems/nautilus_trader) ⭐ 29,257 \| 🐛 130 \| 🌐 Rust \| 📅 2026-09-22**   | High-performance event-driven backtesting and live trading                                                               | Rust core with Python API; nanosecond precision                                                                                                                |
| **[vectorbt](https://github.com/polakowo/vectorbt) ⭐ 9,152 \| 🐛 139 \| 🌐 Python \| 📅 2026-09-17**                     | Vectorized backtesting at scale — thousands of parameter combinations in seconds                                         | Built on NumPy/Numba; ideal for fast strategy sweeps                                                                                                           |
| **[Backtrader](https://github.com/mementum/backtrader) ⭐ 23,303 \| 🐛 63 \| 🌐 Python \| 📅 2024-08-19**                 | Feature-rich event-driven backtesting                                                                                    | Mature and widely taught, though maintenance has slowed                                                                                                        |
...
| **[pybroker](https://github.com/edtechre/pybroker) ⭐ 3,545 \| 🐛 9 \| 🌐 Python \| 📅 2026-09-21**                       | Backtesting framework designed for ML-driven strategies                                                                  | Built-in walk-forward analysis and bootstrapped metrics                                                                                                        |
| **[Riskfolio-Lib](https://github.com/dcajasn/Riskfolio-Lib) ⭐ 4,506 \| 🐛 16 \| 🌐 C++ \| 📅 2026-09-21**                | Portfolio optimization: mean-risk, risk parity, hierarchical clustering methods                                          | 20+ risk measures; strong documentation                                                                                                                        |
| **[skfolio](https://github.com/skfolio/skfolio) ⭐ 2,428 \| 🐛 44 \| 🌐 Python \| 📅 2026-09-21**                         | Portfolio optimization with a scikit-learn-compatible API                                                                | Cross-validation and hyperparameter tuning for allocation models                                                                                               |
| **[Ray/RLlib](https://github.com/ray-project/ray) ⭐ 43,893 \| 🐛 3,612 \| 🌐 Python \| 📅 2026-09-22**                   | Distributed reinforcement learning for adaptive strategies                                                               | Industry-standard RL infrastructure                                                                                                                            |
...
| **[yfinance](https://github.com/ranaroussi/yfinance) ⭐ 25,311 \| 🐛 105 \| 🌐 Python \| 📅 2026-09-17**            | Python wrapper for Yahoo Finance data                                                                                                                                 | Free equity/ETF/FX/crypto prices for research and prototyping                                                           |
...
| **[akshare](https://github.com/akfamily/akshare) ⭐ 22,692 \| 🐛 0 \| 🌐 Python \| 📅 2026-09-20**                  | Free Python library for Chinese market data (A-shares, futures, funds, macro)                                                                                         | China market research; no account required                                                                              |
...
* [awesome-quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 29,694 | 🐛 76 | 🌐 HTML | 📅 2026-09-22 - Curated list of libraries, packages, and resources for quants, organized by programming language.
...
* [awesome-systematic-trading](https://github.com/paperswithbacktest/awesome-systematic-trading) ⭐ 14,389 | 🐛 8 | 🌐 Python | 📅 2026-09-03 - Curated list of systematic trading tools and strategies.
* [awesome-ai-in-finance](https://github.com/georgezouq/awesome-ai-in-finance) ⭐ 6,602 | 🐛 38 | 📅 2026-09-08 - Resources for AI applications in the financial industry.
