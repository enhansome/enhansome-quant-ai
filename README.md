...
* **Key resources**:
  * [Hummingbot](https://github.com/hummingbot/hummingbot) ⭐ 19,661 | 🐛 149 | 🌐 Python | 📅 2026-08-27 - Open-source framework for running market-making and arbitrage bots on centralized and decentralized exchanges.
...
* **Key resources**:
  * [pysystemtrade](https://github.com/robcarver17/pysystemtrade) ⭐ 3,487 | 🐛 31 | 🌐 Python | 📅 2026-07-18 - Robert Carver's open-source systematic futures trading framework implementing his book's methodology.
...
* **Key resources**:
  * [machine-learning-for-trading](https://github.com/stefan-jansen/machine-learning-for-trading) ⭐ 20,688 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-08-27 - Stefan Jansen's companion code to his book: 150+ notebooks covering the full ML4T workflow from data to deployment.
...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 101,044 | 🐛 386 | 🌐 Python | 📅 2026-07-18 - Multi-agent LLM trading framework simulating trading firm dynamics with specialized analyst and trader roles; built with LangGraph, supports GPT, Gemini, Claude, and Grok.
* [Vibe-Trading](https://github.com/HKUDS/Vibe-Trading) ⭐ 31,877 | 🐛 25 | 🌐 Python | 📅 2026-08-27 - Natural-language multi-agent finance research framework with 29 swarm presets (investment committee, quant desk, risk committee); 7 cross-market backtest engines (A-shares/US/Crypto/Futures/Forex/Options) plus a shared-capital CompositeEngine; 5-source auto-fallback data layer (tushare/okx/yfinance/akshare/ccxt); 17-tool MCP server for Claude Desktop; CLI + FastAPI + React frontend.
* [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) ⭐ 21,160 | 🐛 86 | 🌐 Jupyter Notebook | 📅 2026-08-02 - Open-source financial LLM framework with data-centric design and LoRA fine-tuning; supports sentiment analysis, robo-advising, and algorithmic trading.
* [FinRL](https://github.com/AI4Finance-Foundation/FinRL) ⭐ 16,118 | 🐛 309 | 🌐 Jupyter Notebook | 📅 2026-07-13 - Financial reinforcement learning framework supporting A2C, DDPG, PPO, TD3, SAC agents; FinRL-X adds modular infrastructure for the LLM/agentic AI era.
* [FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) ⭐ 7,875 | 🐛 74 | 🌐 Jupyter Notebook | 📅 2026-08-23 - Open-source AI agent platform for financial analysis using LLMs with Financial Chain-of-Thought reasoning and smart scheduler for multi-source LLM integration.
...
* [TimesFM](https://github.com/google-research/timesfm) ⭐ 28,282 | 🐛 224 | 🌐 Python | 📅 2026-07-14 - Google Research's decoder-only foundation model (200M params) pre-trained on 100B real-world time points.
...
* [TimeGPT](https://github.com/Nixtla/nixtla) ⭐ 3,997 | 🐛 67 | 🌐 Jupyter Notebook | 📅 2026-08-27 - Production-ready foundation model trained on 100B+ data points with open-source Python/R SDK; offers zero-shot forecasting and anomaly detection via API.
* [PatchTST](https://github.com/yuqinie98/PatchTST) ⭐ 2,687 | 🐛 60 | 🌐 Python | 📅 2024-08-12 - Segments time series into subseries-level patches as transformer tokens, achieving quadratic reduction in attention cost while retaining local semantics.
...
* [RD-Agent](https://github.com/microsoft/RD-Agent) ⭐ 14,348 | 🐛 199 | 🌐 Python | 📅 2026-08-04 - Microsoft's LLM-based autonomous R\&D agent; its quantitative-finance mode (RD-Agent(Q)) iteratively proposes, codes, and backtests factors and models on top of Qlib.
...
| **Tool**                                                                                                                 | **Strength**                                                                                                             | **Notes**                                                                                                                                                |
| ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[Qlib](https://github.com/microsoft/qlib) ⭐ 47,980 \| 🐛 468 \| 🌐 Python \| 📅 2026-07-23**                           | AI-oriented quant research platform: factor library, model zoo, workflow automation                                      | Microsoft; the reference open-source platform for ML-driven quant research                                                                               |
| **[OpenBB](https://github.com/OpenBB-finance/OpenBB) ⭐ 72,375 \| 🐛 108 \| 🌐 Python \| 📅 2026-07-30**                  | Open-source investment research terminal aggregating equity, macro, and crypto data                                      | Free CLI + SDK; large active community                                                                                                                   |
| **[LEAN](https://github.com/QuantConnect/Lean) ⭐ 21,374 \| 🐛 253 \| 🌐 C# \| 📅 2026-08-27**                            | Institution-grade backtesting and live-trading engine (equities, futures, options, crypto)                               | Open-source engine behind QuantConnect                                                                                                                   |
| **[NautilusTrader](https://github.com/nautechsystems/nautilus_trader) ⭐ 27,948 \| 🐛 118 \| 🌐 Rust \| 📅 2026-08-27**   | High-performance event-driven backtesting and live trading                                                               | Rust core with Python API; nanosecond precision                                                                                                          |
| **[vectorbt](https://github.com/polakowo/vectorbt) ⭐ 8,859 \| 🐛 137 \| 🌐 Python \| 📅 2026-08-02**                     | Vectorized backtesting at scale — thousands of parameter combinations in seconds                                         | Built on NumPy/Numba; ideal for fast strategy sweeps                                                                                                     |
| **[Backtrader](https://github.com/mementum/backtrader) ⭐ 22,992 \| 🐛 63 \| 🌐 Python \| 📅 2024-08-19**                 | Feature-rich event-driven backtesting                                                                                    | Mature and widely taught, though maintenance has slowed                                                                                                  |
...
| **[pybroker](https://github.com/edtechre/pybroker) ⭐ 3,517 \| 🐛 1 \| 🌐 Python \| 📅 2026-08-25**                       | Backtesting framework designed for ML-driven strategies                                                                  | Built-in walk-forward analysis and bootstrapped metrics                                                                                                  |
| **[Riskfolio-Lib](https://github.com/dcajasn/Riskfolio-Lib) ⭐ 4,464 \| 🐛 6 \| 🌐 C++ \| 📅 2026-08-18**                 | Portfolio optimization: mean-risk, risk parity, hierarchical clustering methods                                          | 20+ risk measures; strong documentation                                                                                                                  |
| **[skfolio](https://github.com/skfolio/skfolio) ⭐ 2,288 \| 🐛 27 \| 🌐 Python \| 📅 2026-08-25**                         | Portfolio optimization with a scikit-learn-compatible API                                                                | Cross-validation and hyperparameter tuning for allocation models                                                                                         |
| **[Ray/RLlib](https://github.com/ray-project/ray) ⭐ 43,622 \| 🐛 3,540 \| 🌐 Python \| 📅 2026-08-27**                   | Distributed reinforcement learning for adaptive strategies                                                               | Industry-standard RL infrastructure                                                                                                                      |
...
| **[yfinance](https://github.com/ranaroussi/yfinance) ⭐ 25,087 \| 🐛 103 \| 🌐 Python \| 📅 2026-08-27**            | Python wrapper for Yahoo Finance data                                                                                                                                 | Free equity/ETF/FX/crypto prices for research and prototyping                                             |
...
| **[akshare](https://github.com/akfamily/akshare) ⭐ 22,260 \| 🐛 1 \| 🌐 Python \| 📅 2026-08-26**                  | Free Python library for Chinese market data (A-shares, futures, funds, macro)                                                                                         | China market research; no account required                                                                |
...
* [awesome-quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 29,230 | 🐛 65 | 🌐 HTML | 📅 2026-08-27 - Curated list of libraries, packages, and resources for quants, organized by programming language.
...
* [awesome-systematic-trading](https://github.com/paperswithbacktest/awesome-systematic-trading) ⭐ 14,009 | 🐛 14 | 🌐 Python | 📅 2026-08-27 - Curated list of systematic trading tools and strategies.
